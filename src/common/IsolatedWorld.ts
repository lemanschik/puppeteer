...
// Simply wants the ../injected/injected.js as concat string export source
...
export class IsolatedWorld {
  ...
  #puppeteerUtil = createDeferredPromise<JSHandle<typeof PuppeteerUtil>>();

  get puppeteerUtil(): Promise<JSHandle<typeof PuppeteerUtil>> {
  ...
  async #injectPuppeteerUtil(context: ExecutionContext): Promise<void> {
    try {
      this.#puppeteerUtil.resolve(
        ...
        )) as JSHandle<typeof PuppeteerUtil>
      );
